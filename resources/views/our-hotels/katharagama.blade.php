...
<body>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="#">
                                    <img src="{{ asset('img2/travel-tube-logo.png') }}" height="80" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7">
                    <div class="about_thumb d-flex">
                        ...
                        <div class="img_2">
                            <img src="{{ asset('img2/about/about_4.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="about_info_area">
        <div class="about_active owl-carousel">
            <div class="single_slider kt_bg_1"></div>
            <div class="single_slider kt_bg_2"></div>
            <div class="single_slider kt_bg_3"></div>
            <div class="single_slider kt_bg_4"></div>
            <div class="single_slider kt_bg_5"></div>
        </div>
    </div>
    <!-- about_info_area_start -->
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="single_about_info">
                        <ul>
                            ...
                            <li>Currency exchange on-site</li>
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="single_about_info">
                        <ul>
                            ...
                            <li>Body soap</li>
                            <li>Conditioner</li>
                            <li>Accessibility and suitability</li>
                            <li>Non-feather pillow</li>
                            <li>on-smoking rooms available</li>
